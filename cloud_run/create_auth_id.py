...
def main():
    ...
    # --- RUN_AUTH_ID Registration Logic ---
    try:
        logger.info("Attempting to register RUN_AUTH_ID with Gemini Enterprise...")
        ...
        api_url = (
            ...
            f"authorizations?authorizationId={RUN_AUTH_ID}"
        )

        payload = {
            "name": f"projects/{GOOGLE_CLOUD_PROJECT_NUMBER}/locations/global/authorizations/{RUN_AUTH_ID}",
            "serverSideOauth2": {
        ...
        logger.info("✅ Successfully registered RUN_AUTH_ID to Gemini Enterprise!")
